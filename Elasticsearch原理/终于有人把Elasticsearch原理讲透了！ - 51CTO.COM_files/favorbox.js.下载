...
var favor_app = '';
if (protocolStr == "http:") {
  favor_app = 'http://home.51cto.com/favorite/add-blog-favorite';
} else if (protocolStr == "https:") {
  favor_app = 'https://home.51cto.com/favorite/add-blog-favorite';
}

var favoriteboxurl = favor_app + '?r=1&s=/Index/box';
var favorcloseimg = 'https://home.51cto.com/apps/favorite/Tpl/default/Public/images/close.gif';
